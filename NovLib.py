...
# GUI Created by: PyQt5 UI code generator 5.13.0
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.comboBox.addItems(text.textDict)
        ...
        self.radioButton.setGeometry(QtCore.QRect(20, 360, 140, 16))
        self.radioButton.setObjectName("radioButton")
        
        self.radioButton_2 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_2.setGeometry(QtCore.QRect(20, 380, 195, 18))
    ...
    def replace_text(self, MainWindow):
        ...
        self.textBrowser.append(detokenized_words)
